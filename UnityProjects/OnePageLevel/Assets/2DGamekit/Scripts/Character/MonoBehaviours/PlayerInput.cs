...
namespace Gamekit2D
{
    public class PlayerInput : InputComponent, IDataPersister
    {
        ...
        public InputButton MeleeAttack = new InputButton(KeyCode.None, XboxControllerButtons.None);
        public InputButton RangedAttack = new InputButton(KeyCode.None, XboxControllerButtons.None);
